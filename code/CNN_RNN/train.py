...
def main():
    ...
    parser.add_argument("--recurrent_units", default=512)
    parser.add_argument("--recurrent_type", default="lstm")
    ...
    recurrent_units, recurrent_type = args.recurrent_units, args.recurrent_type
    embedding_name, embedding_trainable = args.embedding_name, args.embedding_trainable
